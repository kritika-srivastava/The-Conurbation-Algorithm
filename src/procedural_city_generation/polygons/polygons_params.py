...
params = [
    ...
    Param("plotbool", False, False,
          "Decides if stuff should be plotted", "boolean"),
    Param("plot_counter", 2, 2,
          "How many iterations have to pass before the plot showing lots updates itself", "integer")
]
